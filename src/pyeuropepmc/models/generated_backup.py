...
class SectionEntity(BaseEntity):
    ...
    citation_contexts: list[str] | None = Field(
        default=[],
        description="""Detailed citation contexts within this section""",
        json_schema_extra={
            "linkml_meta": {
...
class InstitutionEntity(BaseEntity):
    ...
    institution_members: list[str] | None = Field(
        default=[],
