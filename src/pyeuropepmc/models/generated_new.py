...
class BaseEntity(ConfiguredBaseModel):
    ...
    All entities inherit from this base class, providing common
    functionality for validation, normalization, and RDF export.
    """
...
class PaperEntity(ScholarlyWorkEntity):
    ...
    Contains bibliographic metadata, citation information, and
    relationships to authors, institutions, journals, and other entities.
    """
    ...
    paper_institutions: list[InstitutionEntity] | None = Field(
        default=[],
...
class AuthorEntity(BaseEntity):
    ...
    Contains personal information, institutional affiliations,
    and identifiers.
    """
    ...
    author_institutions: list[InstitutionEntity] | None = Field(
        default=[],
    ...
    institutions: list[InstitutionEntity] | None = Field(
        default=[],
...
class InstitutionEntity(BaseEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "from_schema": "https://w3id.org/pyeuropepmc/entities/institution",
    ...
    relationships: list[str] | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["InstitutionEntity"], "slot_uri": "org:relationship"}
        },
    )
    institution_members: list[AuthorEntity] | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["InstitutionEntity"], "slot_uri": "org:hasMember"}
        },
    )
    status: str | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["InstitutionEntity"], "slot_uri": "pyeuropepmc:status"}
        },
    )
    names: list[str] | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["InstitutionEntity"], "slot_uri": "skos:altLabel"}
        },
    )
    locations: list[str] | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["InstitutionEntity"], "slot_uri": "org:siteAddress"}
        },
    )
    links: list[str] | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["InstitutionEntity"], "slot_uri": "foaf:page"}
        },
    )
    id: str | None = Field(
        default=None,
...
class AffiliationEntity(BaseEntity):
    ...
    Contains the relationship between authors and institutions
    with affiliation text.
    """
    ...
    affiliated_institution: InstitutionEntity | None = Field(
        default=None,
