...
# Lazy seaborn style initialization
_plot_style_set = False
sns: Any = None  # Populated by _ensure_plot_style; module-level for existing references


def _ensure_plot_style() -> None:
    """Initialize seaborn plot style on first use."""
    global _plot_style_set, sns
    if not _plot_style_set:
        import seaborn as _sns

        _sns.set_theme(style="whitegrid", palette="muted")
        sns = _sns
...
def plot_publication_years(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_publication_years
...
def plot_citation_distribution(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_citation_distribution
...
def plot_quality_metrics(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_quality_metrics
...
def plot_publication_types(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_publication_types
...
def plot_journals(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_journals
...
def plot_trend_analysis(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_trend_analysis
...
def create_summary_dashboard(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import create_summary_dashboard
...
def plot_access_distribution(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_access_distribution
...
def plot_license_distribution(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_license_distribution
...
def plot_fulltext_availability(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_fulltext_availability
...
def plot_citation_by_access_type(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_citation_by_access_type
...
def plot_author_collaboration_network(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_author_collaboration_network
...
def plot_funding_sources(
    ...
    Examples
    --------
    >>> from pyeuropepmc.features.analytics.visualization import plot_funding_sources
