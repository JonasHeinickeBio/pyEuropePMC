...
class PaginationCheckpoint:
    ...
    def __init__(self, cache_backend: Any, checkpoint_prefix: str = "pagination:checkpoint"):
        ...
        self._lock = {}  # Per-key locks for thread safety
    ...
    def _make_key(self, query: str) -> str:
        ...
        if hasattr(self.cache, "_normalize_key"):
            return self.cache._normalize_key(self.prefix, query=query)
    ...
    def save(self, state: PaginationState) -> None:
        ...
        try:
            ...
            self.cache.set(key, state.to_dict(), ttl=604800)
            logger.debug(
    ...
    def load(self, query: str) -> Optional[PaginationState]:
        """
...
class CursorPaginator:
    ...
    def __init__(
        ...
        query: str,
        page_size: int = 25,
        checkpoint_manager: Optional[PaginationCheckpoint] = None,
        resume: bool = True,
    ):
        """
        ...
        self.state: Optional[PaginationState] = None
